...
def should_skip_kafka_tests() -> bool:
    """
    Determine if Kafka tests should be skipped based on platform and Python version.

    Skips tests for:
    - py311-linux-amd64 (Python 3.11 on Linux AMD64)
    - py39-macos (Python 3.9 on macOS)
    - py311-macos (Python 3.11 on macOS)
    ...
    # Check for py39-macos
    if python_version == "3.9" and system == "darwin":
        return True

    # Check for py312-macos
