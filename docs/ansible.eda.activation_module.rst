.. _ansible.eda.activation_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The token ID of the AWX controller.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: awx_token, token</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>The name of the decision environment associated with the rulebook activation.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: decision_environment</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>The description of the rulebook activation.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>A list of IDs for EDA credentials used by the rulebook activation.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: credentials</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>Whether the rulebook activation is enabled or not.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>A list of IDs representing the event streams that this rulebook activation listens to.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>The extra variables for the rulebook activation.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>k8s_service_name</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                    </div>
                ...
                <td>
                        <div>The name of the Kubernetes service associated with this rulebook activation.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>Allow setting the desired log level.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>The name of the organization.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: organization</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>The name of the project associated with the rulebook activation.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: project</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>The restart policy for the rulebook activation.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>The name of the rulebook associated with the rulebook activation.</div>
                        <div style="font-size: small; color: darkgreen"><br/>aliases: rulebook</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>Allow swapping of single sources in a rulebook without name match.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>A list of webhook IDs associated with the rulebook activation.</div>
                </td>
            </tr>
    </table>
    <br/>
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when exists</td>
                <td>
                            <div>ID of the rulebook activation.</div>
                    <br/>
