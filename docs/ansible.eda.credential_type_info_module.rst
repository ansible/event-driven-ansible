...
To use it in a playbook, specify: ``ansible.eda.credential_type_info``.
...
- \ `ansible.eda.credential\_type\_info <credential_type_info_module.rst>`__\  supports AAP 2.5 and onwards.
...
.. raw:: html
  ...
  <tr>
    <td valign="top">
      ...
      <p style="display: inline;"><strong>credential_types</strong></p>
