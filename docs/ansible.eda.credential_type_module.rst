...
To use it in a playbook, specify: ``ansible.eda.credential_type``.
...
.. raw:: html
  ...
  <tr>
    ...
    <td valign="top">
      <p>The description of the credential type to give more detail about it.</p>
    </td>
  </tr>
  <tr>
    <td valign="top">
      <div class="ansibleOptionAnchor" id="parameter-injectors"></div>
      <p style="display: inline;"><strong>injectors</strong></p>
    ...
    <td valign="top">
      <p>Injectors of the credential type.</p>
    </td>
  </tr>
  <tr>
    <td valign="top">
    ...
    <td valign="top">
      <p>Inputs of the credential type.</p>
    </td>
  </tr>
  <tr>
    <td valign="top">
...
- \ `ansible.eda.credential\_type <credential_type_module.rst>`__\  supports AAP 2.5 and onwards.
