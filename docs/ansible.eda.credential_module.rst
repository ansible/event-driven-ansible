.. _ansible.eda.credential_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Description of the credential.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>Credential inputs where the keys are var names used in templating.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>Name of the credential.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>Setting this option will change the existing name (lookup via name).</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        ...
                        <div style="font-size: small; color: darkgreen"><br/>aliases: org_name</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
