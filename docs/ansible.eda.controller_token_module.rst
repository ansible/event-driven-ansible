.. _ansible.eda.controller_token_module:
...
**Manage AWX tokens in EDA controller**
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>The description of the project.</div>
            ...
            <tr>
                ...
                <td>
                        <div>The name of the AWX token.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when state is &#x27;present&#x27; and successful</td>
                <td>
                            <div>ID of the managed AWX token.</div>
                    <br/>
